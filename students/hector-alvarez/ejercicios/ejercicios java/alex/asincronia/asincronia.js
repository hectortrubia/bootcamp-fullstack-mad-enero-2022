...
navigator.getBattery().then(battery => {
    ...
    if (batteryIsCharging && battery.level === 1) {
        ...
        intervalo = setInterval(() => {
            ...
            if (counter === 5) {
                let bloques = document.querySelectorAll(".carga")
                bloques.forEach(c => c.remove());
                counter = 0;
            }
        ...
        chargfin.textContent = "Por favor conecte el cargador"
